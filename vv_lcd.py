...
def train(args):    
    ...
    #calculate the loss with LCD Loss
    ...
    loss_d_local=loss_d_local+args.lcd_reg*lde_zhengze
    ...
    trainstep.append(tf.train.AdamOptimizer(learning_rate=args.lcd_lr).minimize(loss_d_local, global_step=global_step,var_list=varad))
...
if __name__=='__main__':
    ...
    parser.add_argument('--savepath', type=str, default='./modelvv_lcd/', help='The path of saved checkpoint')
    ...
    parser.add_argument('--lcd_reg', type=float, default=0.0001, help='The regularization parameter of CALoss')
    parser.add_argument('--ae_lr', type=float, default=0.0001, help='The learning rate of reconstruction network')
    parser.add_argument('--lcd_lr', type=float, default=0.001, help='The learning rate of LCD loss')
    parser.add_argument('--sigma', type=float, default=0.01, help='The value of hyer-parameter sigma')
    parser.add_argument('--sigma_r', type=float, default=0.001, help='The value of hyper-parameter sigma_r')
